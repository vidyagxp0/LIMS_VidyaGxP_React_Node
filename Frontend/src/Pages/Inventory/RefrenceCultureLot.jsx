...
function CultureTemplateConfiguration() {
  ...
  const filterData = () => {
    ...
    return filteredData.filter((item) =>
      item.ReferenceLotCode.toLowerCase().includes(search.toLowerCase())
    );
  };
    ...
    <>
      <div id="approval-page" className="m-5 mt-3">
          ...
          <div className="main-head">
            <h4 className="fw-bold ">Reference Culture Lot</h4>
          </div>
          ...
          <CTable align="middle" responsive className="mb-0    table-responsive">
              <CTableHead>
                <CTableRow>
                  ...
                  <CTableHeaderCell  style={{ background: "#5D76A9", color: "white"}} scope="col">Catalogue No.</CTableHeaderCell>
                  <CTableHeaderCell  style={{ background: "#5D76A9", color: "white"}} scope="col">Valid Upto</CTableHeaderCell>
