...
const initialData = [
  {
    checkbox: false,
    sno: 1,
    ColumnName: "application1",
    ColumnNumber: "code1",
    ColumnApplication: "brand1",
    BrandName: "material1",
  ...
  },
  {
    ...
    ColumnName: "column6",
    ColumnNumber: "code6",
    ColumnApplication: "brand6",
    BrandName: "material6",
    PackingMaterial: "material6",
    status: "DROPPED",
  },
  {
    checkbox: false,
    ...
    ColumnName: "column7",
    ColumnNumber: "code7",
    ColumnApplication: "brand7",
    BrandName: "material7",
    PackingMaterial: "material7",
    status: "INITIATED",
  },
];
