...
function PerformanceTest() {
  ...
  const filterData = () => {
    ...
    return filteredData.filter((item) =>
      item.PerformanceTestName.toLowerCase().includes(search.toLowerCase())
    );
  };
  ...
  return (
    <>
      <div id="approval-page" className="m-5 mt-3">
          ...
          <h4 className="fw-bold ">Column Performance test</h4>
          </div>
          ...
          <CTable align="middle" responsive className="mb-0    table-responsive">
              <CTableHead>
                <CTableRow>
                  ...
                  <CTableHeaderCell  style={{ background: "#5D76A9", color: "white"}} scope="col">Performance Test Name		</CTableHeaderCell>
