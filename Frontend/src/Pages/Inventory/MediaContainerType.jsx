...
const MediaContainerType = () => {
  ...
  const filteredData = data.filter((row) => {
    return (
      row.PreparedMediaContainerTypes.toLowerCase().includes(searchQuery.toLowerCase()) &&
  ...
  const columns = [
    ...
    { header: "Prepared Media Container Types", accessor: "PreparedMediaContainerTypes" },
    ...
    <div className="p-4">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="float-right">
          <ATMButton text="Media Container Type" color="blue" onClick={openModal} />
        </div>
      </div>
      <Table
        columns={columns}
