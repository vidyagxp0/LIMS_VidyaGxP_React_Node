...
import AcknowledgeSampleModal from "../Modals/AcknowledgeSampleModal.jsx";
...
const initialData = [
  {
    ...
    ScheduleDate: "Daily maintenance",
    status: "Active",
  },
  {
    checkbox: false,
    ...
    ScheduleDate: "Weekly calibration",
    status: "Active",
  },
  {
    checkbox: false,
    ...
    ScheduleDate: "Monthly inspection",
    status: "Inactive",
  },
  {
    checkbox: false,
  ...
  },
  {
    ...
    ScheduleDate: "Quarterly maintenance",
    status: "Active",
  },
  {
    checkbox: false,
    ...
    ScheduleDate: "Emergency response",
    status: "Active",
  },
];
    ...
    <div className="p-4">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="float-right flex gap-4">
          ...
          <ATMButton text="Acknowledgement" color="blue" onClick={openModal} />
        </div>
      </div>
      <Table
        columns={columns}
