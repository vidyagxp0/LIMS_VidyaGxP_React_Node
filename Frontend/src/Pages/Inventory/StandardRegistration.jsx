...
const initialData = [
  ...
  },
  {
    ...
    SequenceNo: "sequence4",
    status: "APPROVED",
  },
  {
    checkbox: false,
    sno: 5,
    StandardName: "standard5",
    SequenceNo: "sequence5",
    status: "REJECTED",
  },
  {
    checkbox: false,
    sno: 6,
    StandardName: "standard6",
    SequenceNo: "sequence6",
    status: "DROPPED",
  },
  {
    checkbox: false,
    sno: 7,
    StandardName: "standard7",
    SequenceNo: "sequence7",
    status: "INITIATED",
  },
];
...
const StandardRegistration = () => {
  ...
  const columns = [
    ...
    { header: "Sequence No.", accessor: "SequenceNo" },
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Reference Standard Registration
      </h1>
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="float-right">
          <ATMButton text="Add Standard" color="blue" onClick={openModal} />
        </div>
      </div>
      <Table
        columns={columns}
