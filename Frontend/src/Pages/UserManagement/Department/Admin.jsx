...
//       const formattedData = response.data[0]?.storageCondition || [];
...
//     setLoading(true);
//     try {
//       const response = await axios.post(`${BASE_URL}/manage-lims/add/departmentAdmin`, {
//         employeeId: newCondition.employeeId,
//         storageName: newCondition.storageName,
//         role: newCondition.role,
//         email: newCondition.email,
//         addedOn: new Date().toISOString().split("T")[0],
//         attachment: newCondition.attachment,
//         status: "Active",
//       });

//       if (response.status === 200) {
//         const addadmin = response.data.addLIMS;
//         setData((prevData) => [
//           ...prevData,
//           {
//             ...addadmin,
//             sno: addadmin.uniqueId,
//             checkbox: false,
//           },
//         ])
        
//         toast.success("Admin added successfully");
//         fetchStorageCondition(); // Refresh the data
//       }
//     } catch (error) {
...
//   //   setData((prevData) => [
//   //     ...prevData,
//   //     { ...addedStorageCondition, sno: prevData.length + 1, checkbox: false },
//   //   ])
//   //   toast.success(" Admin added successfully")
//   //   closeModal()
//   //   fetchStorageCondition()
...
//           <PDFDownload columns={columns} data={filteredData} fileName="User_Admin.pdf" title="User Management Admin Data" />
