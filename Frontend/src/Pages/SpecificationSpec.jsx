      ...
      <table className="min-w-full bg-white border border-gray-200 shadow-lg ">
        <thead>
          ...
          <tr className="">
            ...
            <td className="bg-black text-white  px-4 py-2">Specification Title/Name</td>
            ...
            <td className="bg-black text-white  px-4 py-2">Manufacturer/Supplier</td>
            <td className="bg-black text-white border px-4 py-2">Description</td>
            <td className="bg-black text-white border px-4 py-2">Material Grade</td>
            <td className="bg-black text-white border px-4 py-2">Molecular Formula</td>
            <td className="bg-black text-white border px-4 py-2">Packaging Requirements</td>
            <td className="bg-black text-white border px-4 py-2">Storage Conditions</td>
            <td className="bg-black text-white border px-4 py-2">Shelf Life</td>
            <td className="bg-black text-white border px-4 py-2">Labeling Requirements</td>
            <td className="bg-black text-white border px-4 py-2">Test Parameter</td>
            <td className="bg-black text-white border px-4 py-2">Test Method</td>
            <td className="bg-black text-white border px-4 py-2">Acceptance Criteria</td>
            <td className="bg-black text-white border px-4 py-2">Units of Measurement</td>
            <td className="bg-black text-white border px-4 py-2">Test Frequency</td>
            <td className="bg-black text-white border px-4 py-2">Control Sample Reference</td>
            <td className="bg-black text-white border px-4 py-2">Sampling Plan</td>
            <td className="bg-black text-white border px-4 py-2">Test Method Validation</td>
            <td className="bg-black text-white border px-4 py-2">Reference Standards</td>
            <td className="bg-black text-white border px-4 py-2">Result Interpretation</td>
            <td className="bg-black text-white border px-4 py-2">Stability Criteria</td>
            <td className="bg-black text-white border px-4 py-2">Re-Testing Interval</td>
            <td className="bg-black text-white border px-4 py-2">Regulatory Requirements</td>
            <td className="bg-black text-white border px-4 py-2">Certification</td>
            <td className="bg-black text-white border px-4 py-2">Deviation Handling</td>
            <td className="bg-black text-white border px-4 py-2">Audit Trail</td>
            <td className="bg-black text-white border px-4 py-2">Document Reference</td>
            <td className="bg-black text-white border px-4 py-2">Revision History</td>
            <td className="bg-black text-white border px-4 py-2">Attachments</td>
            <td className="bg-black text-white border px-4 py-2">Comments/Remarks</td>
            <td className="bg-black text-white border px-4 py-2">Specification Review Frequency</td>
            <td className="bg-black text-white border px-4 py-2">Specification Expiry</td>
          </tr>
        </thead>
        <tbody>
