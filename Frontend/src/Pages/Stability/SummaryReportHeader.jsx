...
function SummaryReportHeader() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        `https://lims-api.mydemosoftware.com/get-all-lims/sMSummaryReportHeader`
      );
  ...
  const handleStatusUpdate = async (newStatus) => {
    try {
      ...
      const response = await axios.put(
        `https://lims-api.mydemosoftware.com/manage-lims/update/sMStandardProtocol/${viewModalData.uniqueId}`,
        {
          ...dataToSend,
          status: newStatus,
        }
  ...
  const handleDelete = async (item) => {
    ...
    try {
      const response = await axios.delete(
        `https://lims-api.mydemosoftware.com/delete-lims/sMSummaryReportHeader/${item.uniqueId}`
      );
      if (response.status === 200) {
  ...
  const handleAdd = async (newProduct) => {
    try {
      const response = await axios.post(
        `https://lims-api.mydemosoftware.com/manage-lims/add/sMSummaryReportHeader`,
        {
          ...newProduct,
  ...
  const handleEditSave = async (updatedData) => {
    ...
    try {
      const response = await axios.put(
        `https://lims-api.mydemosoftware.com/manage-lims/update/sMSummaryReportHeader/${updatedData.uniqueId}`,
        dataTosend
      );
      if (response.status === 200) {
