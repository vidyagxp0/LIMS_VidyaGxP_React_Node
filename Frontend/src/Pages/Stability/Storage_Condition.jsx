...
function Storage_Condition() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        `https://lims-api.mydemosoftware.com/get-all-lims/sMStorageCondition`
      );
  ...
  const handleEditSave = async (updatedData) => {
    ...
    try {
      const response = await axios.put(
        `https://lims-api.mydemosoftware.com/manage-lims/update/sMStorageCondition/${updatedData.uniqueId}`,
        dataToSend
      );
  ...
  const handleStatusUpdate = async (newStatus) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://lims-api.mydemosoftware.com/manage-lims/update/sMStorageCondition/${viewModalData.uniqueId}`,
        {
          ...dataToSend,
          status: newStatus,
        }
  ...
  const handleDelete = async (item) => {
    ...
    try {
      const response = await axios.delete(
        `https://lims-api.mydemosoftware.com/delete-lims/sMStorageCondition/${item.uniqueId}`
      );
      if (response.status === 200) {
  ...
  const handleAdd = async (newSampleType) => {
    try {
      const response = await axios.post(
        `https://lims-api.mydemosoftware.com/manage-lims/add/sMStorageCondition`,
        {
          ...newSampleType,
