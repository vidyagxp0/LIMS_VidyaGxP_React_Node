    ...
    return (
        <div className='m-5 shadow rounded px-5 py-3'>
            ...
            <table className='table table-bordered border-dark my-3'>
                <thead>
                    <tr>
                        ...
                        <th className='bg-info text-light'>Test Category</th>
                        <th className='bg-info text-light'>Test Name</th>
                        <th className='bg-info text-light'>Test Technique</th>
            ...
            <div className="d-flex gap-4 mt-4 mx-4">
                ...
                <div className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#rawDataPreviewModal">Worksheet Preview</div>
            ...
            <div className="modal fade" id="rawDataPreviewModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-lg modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <h6>Test Name</h6>
                            <h6>Water Content PPM</h6>
                            <h3 className="fs-5 mt-4">Worksheet Data</h3>
                            CHQTY0001: <span className='text-muted bg-warning-subtle rounded p-1'>CHQTY0001</span> <hr className='text-light m-2' />
                            weight and transfer <span className='text-muted bg-warning-subtle rounded p-1'>CHQTY0001</span>of substance. <hr className='text-light m-2' />
                            <h6>Test Name</h6>
                            <h6>Total Acid Number (TAN)</h6>
                            <h3 className="fs-5 mt-4">Worksheet Data</h3>
                            <h6>Test Name</h6>
                            <h6>Viscosity @40C</h6>
                            <h3 className="fs-5 mt-4">Worksheet Data</h3>
...
export default Sample_LoginDetails
