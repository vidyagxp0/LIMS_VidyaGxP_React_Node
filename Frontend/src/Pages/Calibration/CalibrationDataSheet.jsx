...
const CalibrationDataSheet = () => {
  ...
  const filterData = () => {
    ...
    return employees.filter(
      (employees) => employees.status === selectedStatus.toUpperCase()
    );
  };
  ...
  const [employees, setEmployees] = useState([
    ...
    {
      id: 2,
      fieldName: "sampling check list",
      fieldType: "Label",
      registeredBy: "Admin",
      registeredOn: "2024-05-16",
      status: "REINITIATED",
    },
    {
      id: 3,
    ...
    return filteredEmployees
      ...
      .map((employee, index) => (
        <tr key={startIndex + index}>
          ...
          <td>
            <Link to="/calibration/calibration-datasheet-details">
    ...
    <div className="m-5 mt-3">
      ...
      <div className="row mt-3" style={{ cursor: "pointer" }}>
        <button
          ...
          style={{
            background: "linear-gradient(25deg, #0250c5 0%, #d43f8d 100%)",
        ...
        >
          ...
          <div
            ...
            style={{ color: "white" }}
          >
            {filterData().filter((item) => item.status === "DROPPED").length}
          </div>
        </button>
        <button
          className="col shadow p-3 m-3 rounded"
          style={{
            background: "linear-gradient(25deg, #13517a 6% , #2A5298 50%)",
            textAlign: "left",
          }}
        ...
        >
          ...
          <div
            ...
            style={{ color: "white" }}
          >
            {filterData().filter((item) => item.status === "INITIATED").length}
          </div>
        </button>
        <button
          className="col shadow p-3 m-3 rounded"
        ...
        >
          ...
          >
            {
              filterData().filter((item) => item.status === "REINITIATED")
                .length
            }
          </div>
        </button>
        ...
        >
          ...
          >
            {filterData().filter((item) => item.status === "APPROVED").length}
          </div>
        </button>
        ...
        >
          ...
          <div className="count fs-1 text-light fw-bolder">
            {filterData().filter((item) => item.status === "REJECTED").length}
          </div>
        </button>
      </div>
