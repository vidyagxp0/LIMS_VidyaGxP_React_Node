  ...
  return (
    <CModal alignment="center" visible={visible} onClose={closeModal} size="lg">
      ...
      <CFormInput
        ...
        onChange={(e) => handleInputChange("SupervisorManagerName", e.target.value)}
      ...
      <CFormInput
        ...
        onChange={(e) => handleInputChange("DateOfQualification", e.target.value)}
      ...
      <CFormInput
        ...
        onChange={(e) => handleInputChange("TrainingProgramName", e.target.value)}
      />
      <CFormInput
        className="mb-3"
        type="date"
      ...
      <CFormSelect
        ...
        onChange={(e) => handleInputChange("TrainingCompletionStatus", e.target.value)}
        options={[
          "Select...",
      ...
      <CFormInput
        ...
        onChange={(e) => handleInputChange("CertificationNameNumber", e.target.value)}
      />
      <CFormInput
        className="mb-3"
        type="text"
      ...
      <CFormInput
        ...
        onChange={(e) => handleInputChange("NextRecertificationDate", e.target.value)}
      />
      <CFormInput
        className="mb-3"
        type="text"
        ...
        onChange={(e) => handleInputChange("CompetencyTestName", e.target.value)}
      />
      <CFormInput
        className="mb-3"
        type="date"
      ...
      <CFormInput
        ...
        onChange={(e) => handleInputChange("EvaluatorComments", e.target.value)}
      />
      <CFormInput
        className="mb-3"
        type="text"
        ...
        onChange={(e) => handleInputChange("TechniqueSkillName", e.target.value)}
      />
      <CFormInput
        className="mb-3"
        type="date"
      ...
      <CFormSelect
        ...
        onChange={(e) => handleInputChange("RequalificationRequired", e.target.value)}
        options={[
          "Select...",
          { label: "Yes", value: "Yes" },
          { label: "No", value: "No" },
      ...
      <CFormInput
        ...
        onChange={(e) => handleInputChange("RequalificationDueDate", e.target.value)}
      />
      <CFormInput
        className="mb-3"
        type="text"
        ...
        onChange={(e) => handleInputChange("InstrumentNameID", e.target.value)}
      />
      <CFormInput
        className="mb-3"
        type="text"
      ...
      <CFormInput
        ...
        onChange={(e) => handleInputChange("MethodValidationDate", e.target.value)}
      />
      <CFormInput
        className="mb-3"
        type="text"
      ...
      <CFormInput
        ...
        onChange={(e) => handleInputChange("DateAcknowledgedReviewed", e.target.value)}
      />
      <CFormInput
        className="mb-3"
        type="date"
        ...
        onChange={(e) => handleInputChange("RevisionDueDate", e.target.value)}
      />
      <CFormInput
        className="mb-3"
        type="number"
      ...
      <CFormInput
        ...
        onChange={(e) => handleInputChange("PreviousJobRoles", e.target.value)}
      />
      <CFormInput
        className="mb-3"
        type="text"
        ...
        onChange={(e) => handleInputChange("PreviousLabsWorkedIn", e.target.value)}
      />
      <CFormInput
        className="mb-3"
        type="text"
      ...
      <CFormInput
        ...
        onChange={(e) => handleInputChange("ApproversSignature", e.target.value)}
      />
      <CFormInput
        className="mb-3"
        type="text"
