...
const Table = ({ columns, data, onCheckboxChange, onViewDetails }) => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case "Active":
        return "bg-green-500 text-white w-24 flex items-center justify-center  p-1";
      case "Inactive":
        return "bg-red-500 text-white w-24 flex items-center justify-center  p-1";
      case "DROPPED":
        return "bg-pink-500 text-white w-24 flex items-center justify-center  p-1";
      case "REJECTED":
        return "bg-red-500 text-white w-24 flex items-center justify-center  p-1";
      case "INITIATED":
        return "bg-blue-500 text-white w-24 flex items-center justify-center  p-1";
      case "REINITIATED":
        return "bg-yellow-500 text-white w-24 flex items-center justify-center  p-1";
      case "APPROVED":
        return "bg-green-500 text-white w-24 flex items-center justify-center  p-1";
      default:
        return "";
