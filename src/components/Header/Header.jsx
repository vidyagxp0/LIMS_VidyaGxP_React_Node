...
function Header() {
  ...
  return (
    <>
      <header className="border-bottom h-100 d-flex align-items-center py-3">
        <div className="container-fluid">
          <div className="row align-items-center">
            ...
            <div className="col-12 col-md-2 text-center text-md-end mb-2 mb-md-0">
            ...
            <div className="col-12 col-md-2 text-center text-md-end">
              <div className="d-flex justify-content-center justify-content-md-end align-items-center">
                <div className="position-relative me-4">
                  <Link onClick={() => setNotification(!notification)}>
                    <FontAwesomeIcon icon={faBell} className="fs-5" />
                    <span className="position-absolute top-0 start-100 translate-middle badge rounded-pill text-bg-danger text-light" style={{ padding: "3px 4px" }}>
                  ...
                  {notification && (
                    <div className="border shadow bg-white list-group" style={notifyStyle}>
                      ...
                      <a href="#" className="list-group-item list-group-item-action">
                        Error occurred during submission. <br />
                ...
                <div className="position-relative">
                  ...
                  {drop && (
                    <div className="border shadow bg-white flex  flex-col justify-center items-start" style={dropStyle}>
