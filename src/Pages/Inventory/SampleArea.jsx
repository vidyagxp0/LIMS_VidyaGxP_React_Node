      ...
      <div id="approval-page" className="h-100 mx-5">
        <div className="container-fluid my-5">
          <div className="main-head">
            <div className="title fw-bold fs-5 mb-5">Sample Area</div>
          </div>
          ...
          <CTable align="middle" responsive className="mb-0    table-responsive">
              <CTableHead>
                <CTableRow>
                  ...
                  <CTableHeaderCell  style={{ background: "#5D76A9", color: "white"}} scope="col">Category		</CTableHeaderCell>
                  <CTableHeaderCell  style={{ background: "#5D76A9", color: "white"}} scope="col">SampleArea		</CTableHeaderCell>
                ...
                {filterData().slice(startIndex, endIndex)
                  ...
                  .map((item, index) => (
                    <CTableRow key={index}>
                      ...
                      <CTableDataCell>{item.SampleArea	}</CTableDataCell>
