          ...
          <CTable align="middle" responsive className="mb-0 table-striped table-responsive">
              <CTableHead>
                <CTableRow>
                  ...
                  <CTableHeaderCell   style={{background:"#3C496A", color:"white"}} scope="col">Flow Rate	</CTableHeaderCell>
                  <CTableHeaderCell  style={{background:"#3C496A", color:"white"}}  scope="col">Wave Length	</CTableHeaderCell>
                  <CTableHeaderCell  style={{background:"#3C496A", color:"white"}}  scope="col">Injector</CTableHeaderCell>
