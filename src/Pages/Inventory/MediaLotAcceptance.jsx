          ...
          <CTable align="middle" responsive className="mb-0    table-responsive">
              <CTableHead>
                <CTableRow>
                  ...
                  <CTableHeaderCell  style={{ background: "#5D76A9", color: "white"}} scope="col">Media Lot No.		 </CTableHeaderCell>
                  ...
                  <CTableHeaderCell  style={{ background: "#5D76A9", color: "white"}} scope="col">Sample	</CTableHeaderCell>
