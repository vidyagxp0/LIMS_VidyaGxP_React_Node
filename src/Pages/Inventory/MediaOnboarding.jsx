          ...
          <CTable align="middle" responsive className="mb-0 table-striped table-responsive">
              <CTableHead>
                <CTableRow>
                  ...
                  <CTableHeaderCell  style={{background:"#3C496A", color:"white"}} scope="col">Media Prefix</CTableHeaderCell>

                  <CTableHeaderCell  style={{background:"#3C496A", color:"white"}} scope="col">
                    Storage Condition{" "}
                  </CTableHeaderCell>
                  <CTableHeaderCell  style={{background:"#3C496A", color:"white"}} scope="col">UOM </CTableHeaderCell>
                  <CTableHeaderCell  style={{background:"#3C496A", color:"white"}} scope="col">
                    Mode Of Preparation{" "}
                  </CTableHeaderCell>
