    ...
    <>
      <div id="approval-page" className="h-100 mx-5">
        <div className="container-fluid my-5">
          ...
          <div
            className=" table-responsive bg-white rounded py-3 px-4 mt-5 "
...
const StatusModal = (_props) => {
  return (
    ...
    >
      ...
      <CModalBody>
        <CFormInput type="text" label="Standard Protocol Name" placeholder="" />
        <CFormInput type="text" label="Standard Protocol Id" placeholder="" />
