                                   ...
                                   <CTable align="middle" className="mb-0" small bordered>
                                        <CTableBody>
                                            <CHeader className="bg-light">Header</CHeader>
                                             <CTableRow >
                                                  <CTableDataCell className="text-light bg-info">Header Rows</CTableDataCell>
                                                  <CTableDataCell>1</CTableDataCell>                                                  
                                             </CTableRow>
                                             <CTableRow >
                                                  <CTableDataCell className="text-light bg-info">Header Columns</CTableDataCell>
                                                  <CTableDataCell>2</CTableDataCell>                                                  
                                             </CTableRow>
                                             <CTableRow >
                                                  <CTableDataCell className="text-light bg-info">Sample Field 1</CTableDataCell>
                                             ...
                                             <CTableRow >
                                                  <CTableDataCell className="text-light bg-info">Sample Field 2</CTableDataCell>
                                                  <CTableDataCell>approved_by</CTableDataCell>                                                  
                                             </CTableRow>
                                             <CTableRow >
                                                  <CTableDataCell className="text-light bg-info">Sample Field 3</CTableDataCell>
                                                  <CTableDataCell>reviewed_by</CTableDataCell>                                                  
                                             </CTableRow>
                                             <CTableRow >
                                                  <CTableDataCell className="text-light bg-info">Sample Field 4</CTableDataCell>
