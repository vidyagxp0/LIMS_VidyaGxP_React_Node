...
function StorageChamber() {
    ...
    const [data, setData] = useState([
        ...
        { id: 3, chamberId: "test", description: "NA", makeModel: "testing525", serialNo: "25255488", location: "Lab1", status: "REJECTED" },
        { id: 4, chamberId: "chmb4", description: "Temperature controlled", makeModel: "coolerX200", serialNo: "85236974", location: "Warehouse", status: "APPROVED" },
        { id: 5, chamberId: "chmb5", description: "Humidity controlled", makeModel: "humidX100", serialNo: "96325874", location: "Lab2", status: "REJECTED" },
        { id: 6, chamberId: "chmb6", description: "High pressure", makeModel: "pressurX500", serialNo: "15975326", location: "Plant2", status: "APPROVED" },
        { id: 7, chamberId: "chmb7", description: "Vacuum chamber", makeModel: "vacuumV700", serialNo: "75395184", location: "Plant3", status: "INITIATED" },
        { id: 8, chamberId: "chmb8", description: "Thermal chamber", makeModel: "thermoT300", serialNo: "45612378", location: "loc2", status: "APPROVED" },
        { id: 9, chamberId: "chmb9", description: "Soundproof", makeModel: "soundS100", serialNo: "14725836", location: "Lab3", status: "INITIATED" },
        { id: 10, chamberId: "chmb10", description: "Refrigerated", makeModel: "refrigR400", serialNo: "32165498", location: "Plant4", status: "REJECTED" },
        { id: 11, chamberId: "chmb11", description: "Cryogenic", makeModel: "cryoC600", serialNo: "78945612", location: "Warehouse", status: "APPROVED" },
        { id: 12, chamberId: "chmb12", description: "Dust-free", makeModel: "dustD200", serialNo: "12378945", location: "Lab4", status: "INITIATED" },
    ]);
                        ...
                        <CRow className="mb-3">
                            ...
                            <CCol sm={3}>
                                <div className="d-flex justify-content-end">
                                    <CButton color="primary" onClick={() => setAddModal(true)}>Add Chamber</CButton>
                                </div>
                            </CCol>
                        </CRow>
                    </div>
