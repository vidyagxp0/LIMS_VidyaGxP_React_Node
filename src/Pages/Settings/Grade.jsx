               ...
               <div id="approval-page" className="h-100 mx-5">
                    <div className="container-fluid my-5">
                         ...
                         <div className="main-head">
                              <h4 className="fw-bold mb-4 mt-3">Grades</h4>
                         </div>
                         <div>
                              <CRow className="mb-3">
                                   <CCol sm={4}>
                                   ...
                                   <CCol sm={3}>
                                        <div className="d-flex justify-content-end">
                                             <CButton className="bg-info text-white" onClick={() => setAddModal(true)}>Add Grade</CButton>
                                        </div>
                                   </CCol>
                              </CRow>
                         </div>
                              ...
                              <CTable align="middle" responsive className=" shadow">
                                   ...
                                   <CTableBody>
                                        <CTableRow>
                                             ...
                                             <CTableDataCell>GR-052024-0000008</CTableDataCell>
                                             <CTableDataCell>Analytical Grade</CTableDataCell>                                        
                                        ...
                                        <CTableRow>
                                             ...
                                             <CTableDataCell>GR-052024-0000008</CTableDataCell>
                                             <CTableDataCell>HPLC Grade</CTableDataCell>                                        
                                             <CTableDataCell className="d-flex">
                                                  <div className="py-2 px-3 small rounded fw-bold" style={badgeStyle}>ACTIVE</div>
                                             </CTableDataCell>
                                             <CTableDataCell>
     ...
     return (
          <>
               ...
               <CModal alignment="center" visible={_props.visible} onClose={_props.closeModal}>
                    <CModalHeader>
                         <CModalTitle>New Grade</CModalTitle>
                    </CModalHeader>
                    <CModalBody>
                    ...
                    <CModalFooter>
                         ...
                         <CButton className="bg-info text-white">Add Grade</CButton>
                    </CModalFooter>
               </CModal>
