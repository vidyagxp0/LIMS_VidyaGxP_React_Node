                    ...
                    <CTableRow key={index}>
                      ...
                      <CTableDataCell className="d-flex">
                        <div
                          ...
                          style={item.status === "Inactive" ? badgeStyle2 : badgeStyle}
                        >
                          {item.status}
                        </div>
                      </CTableDataCell>
    ...
    return (
      <>
        <CModal alignment="center" visible={_props.visible} onClose={_props.closeModal} size="lg">
          <CModalHeader>
            <CModalTitle>Delete Service Reporting</CModalTitle>
          </CModalHeader>
          <CModalBody>
            <p>
              Do you want to delete this Service reporting <code>test</code>?
            </p>
          </CModalBody>
          <CModalFooter>
            <CButton color="light" onClick={_props.closeModal}>
